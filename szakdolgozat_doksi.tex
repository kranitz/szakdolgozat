...
{\bf Kulcsszavak:} {\it Zorp, TcpForwarder, rögzítés, visszajátszás, teljesítményteszt, keretrendszer}
\newpage
...
The topic of this thesis is to develop a framework what makes easier to test firewalls with playback of pre-recorded network traffic.

The development of the framework was done in Python, however to modifie some part of the system I had to change C++ source code too. For those modifications I used Qt.

\vspace{2cm}

{\bf Keywords:} {\it Zorp, TcpForwarder, record, replay, performancetest, framework}
\newpage
%--------------%------------------------------------------------------------------
